  ...
  return (
    <div className="about-container">
      ...
      <p className="about-description">
        ...
        finance. The edition of the Expo Crypto Link will take place during on
        25th of June, 2024 in Dubai, with the world’s top crypto companies and
        blockchain entrepreneurs. Today, UAE, specifically Dubai is gearing up
        to become a global crypto hub. Thus, Expo Crypto Link will be the
        gathering in the region on behalf of the world of blockchain and
        cryptocurrency, with a wide range of topics focused on the financial
        technologies of the future, extensive networking opportunities and
