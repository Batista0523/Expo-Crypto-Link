  ...
  return (
    <div>
      ...
      <svg
        ...
        width="auto"
        height="100"
        viewBox="0 0 1500 681"
      >
        <g transform="matrix(1,0,0,1,-0.9090909090909918,0.5227454736828463)">
          <svg
            viewBox="0 0 396 180"
          ...
          >
            <g
              id="tight-bounds"
              transform="matrix(1,0,0,1,0.2400000000000091,-0.1381706097840123)"
            >
              <svg
                viewBox="0 0 395.52 180.27634121956802"
                height="180.27634121956802"
                width="395.52"
              >
                <g>
                  <svg
                    ...
                    width="395.52"
                  >
                    <g transform="matrix(1,0,0,1,0,134.1344863546152)">
                      <svg
                        viewBox="0 0 395.52 46.14185486495281"
                        height="46.14185486495281"
                        width="395.52"
                      >
                    ...
                    <g transform="matrix(1,0,0,1,141.585741351791,0)">
                      <svg
                        viewBox="0 0 112.348517296418 112.348517296418"
                        height="112.348517296418"
                        width="112.348517296418"
                      >
                        <g>
                          <svg></svg>
                        </g>
                        <g id="icon-0">
                          ...
                          >
                            <g>
                              <path
                                d="M0 56.174c0-31.024 25.15-56.174 56.174-56.174 31.024 0 56.174 25.15 56.175 56.174 0 31.024-25.15 56.174-56.175 56.175-31.024 0-56.174-25.15-56.174-56.175zM56.174 108.187c28.726 0 52.013-23.287 52.013-52.013 0-28.726-23.287-52.013-52.013-52.013-28.726 0-52.013 23.287-52.013 52.013 0 28.726 23.287 52.013 52.013 52.013z"
                                data-fill-palette-color="accent"
                                fill="#f84e45"
                                stroke="transparent"
                              ></path>
                              <ellipse
                                rx="55.61251606172691"
                                ry="55.61251606172691"
                                cx="56.174258648209"
                                cy="56.174258648209"
                                fill="#f84e45"
                                stroke="transparent"
                            ...
                            <g transform="matrix(1,0,0,1,23.666318560909474,32.38364777471972)">
                              <svg
                                viewBox="0 0 65.01588017459905 47.581221746978564"
                                height="47.581221746978564"
                                width="65.01588017459905"
                              >
                                <g>
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
